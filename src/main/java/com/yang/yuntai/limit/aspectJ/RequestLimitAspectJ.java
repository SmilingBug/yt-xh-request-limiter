...
import com.yang.yuntai.limit.constants.LimitType;
...
@Aspect
@Configuration
public class RequestLimitAspectJ {
    ...
    @Autowired
    public RequestLimitAspectJ(RedisTemplate<String, Serializable> limitRedisTemplate) {
        this.limitRedisTemplate = limitRedisTemplate;
    }

    @Around("execution(public * *(..)) && @annotation(com.yang.yuntai.limit.annotation.RequestLimiter)")
    public Object interceptor(ProceedingJoinPoint pjp) {
        ...
        try {
            ...
            if (count != null && count.intValue() <= limitCount) {
                ...
                throw new RequestLimitException("You have been dragged into the blacklist");
            }
        } catch (Throwable e) {
